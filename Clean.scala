...
object CleanCaracteristiques {

  def main(args: Array[String]) {

    val PATH = "src/main/ressources/FichiersCarac/" // HDFS_PATH : "/home/fitec/git/projet/" //"hdfs://172.17.0.4:8020/user/cloudera/projet/dataRaw/"

    //Create a SparkContext to initialize Spark
    val conf = new SparkConf().setMaster("local[*]").setAppName("Concat caracteristiques")
    ...
    val textFile05 = loadfileFromHDFS(true, true, "caracteristiques_2005.csv", "csv", ",")
    val textFile06 = loadfileFromHDFS(true, true, "caracteristiques_2006.csv", "csv", ",")
    val textFile07 = loadfileFromHDFS(true, true, "caracteristiques_2007.csv", "csv", ",")
    val textFile08 = loadfileFromHDFS(true, true, "caracteristiques_2008.csv", "csv", ",")
    val textFile09 = loadfileFromHDFS(true, true, "caracteristiques_2009.csv", "csv", ",")
    val textFile10 = loadfileFromHDFS(true, true, "caracteristiques_2010.csv", "csv", ",")
    val textFile11 = loadfileFromHDFS(true, true, "caracteristiques_2011.csv", "csv", ",")
    val textFile12 = loadfileFromHDFS(true, true, "caracteristiques_2012.csv", "csv", ",")
    val textFile13 = loadfileFromHDFS(true, true, "caracteristiques_2013.csv", "csv", ",")
    val textFile14 = loadfileFromHDFS(true, true, "caracteristiques_2014.csv", "csv", ",")
    val textFile15 = loadfileFromHDFS(true, true, "caracteristiques_2015.csv", "csv", ",")
    val textFile16 = loadfileFromHDFS(true, true, "caracteristiques_2016.csv", "csv", ",")
    val textFile17 = loadfileFromHDFS(true, true, "caracteristiques-2017.csv", "csv", ",")
...
*/
    ...
    textFile05.union(textFile06).union(textFile07).union(textFile08).coalesce(1).write.csv("src/main/ressources/output")
    // temp.union(textFile09).union(textFile10).union(textFile11).union(textFile12).union(textFile13).union(textFile14).union(textFile15).union(textFile16).union(textFile17).coalesce(1).write.csv("src/main/ressources/output")
