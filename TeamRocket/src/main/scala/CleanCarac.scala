...
*/
    ...
    textFile05.union(textFile06).union(textFile07).union(textFile08).union(textFile09).union(textFile10).union(textFile11).union(textFile12).union(textFile13).union(textFile14).union(textFile15).union(textFile16).union(textFile17).coalesce(1).write.csv("src/main/ressources/output5")
