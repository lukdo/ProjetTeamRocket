...
object CleanUsers {
  ...
  def main(args: Array[String]) {
    ...
    val PATH = "src/main/ressources/FichiersUsers/" // HDFS_PATH : "/home/fitec/git/projet/" //"hdfs://172.17.0.4:8020/user/cloudera/projet/dataRaw/"
    //val PATH = "hdfs://172.17.0.3:8020/user/cloudera/Projet/"

    //Create a SparkContext to initialize Spark
    val conf = new SparkConf().setMaster("local[*]").setAppName("Concat users")
...
*/
    ...
    val textFile05 = loadfileFromHDFS(true, true, "usagers_2005.csv", "csv", ",")
    val textFile06 = loadfileFromHDFS(true, true, "usagers_2006.csv", "csv", ",")
    val textFile07 = loadfileFromHDFS(true, true, "usagers_2007.csv", "csv", ",")
    val textFile08 = loadfileFromHDFS(true, true, "usagers_2008.csv", "csv", ",")
    val textFile09 = loadfileFromHDFS(true, true, "usagers_2009.csv", "csv", ",")
    val textFile10 = loadfileFromHDFS(true, true, "usagers_2010.csv", "csv", ",")
    val textFile11 = loadfileFromHDFS(true, true, "usagers_2011.csv", "csv", ",")
    val textFile12 = loadfileFromHDFS(true, true, "usagers_2012.csv", "csv", ",")
    val textFile13 = loadfileFromHDFS(true, true, "usagers_2013.csv", "csv", ",")
    val textFile14 = loadfileFromHDFS(true, true, "usagers_2014.csv", "csv", ",")
    val textFile15 = loadfileFromHDFS(true, true, "usagers_2015.csv", "csv", ",")
    val textFile16 = loadfileFromHDFS(true, true, "usagers_2016.csv", "csv", ",")
    val textFile17 = loadfileFromHDFS(true, true, "usagers-2017.csv", "csv", ",")
